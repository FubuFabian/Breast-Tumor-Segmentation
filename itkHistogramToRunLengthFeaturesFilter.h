...
public:
  ...
  void SetRequestedFeature(int feature);
...
protected:
  ...
  void GenerateShortRunEmphasisData();
  
  void GenerateLongRunEmphasisData();
  
  void GenerateGreyLevelNonuniformityData();
  
  void GenerateRunLengthNonuniformityData();
  
  void GenerateLowGreyLevelRunEmphasisData();
  
  void GenerateHighGreyLevelRunEmphasisData();
  
  void GenerateShortRunLowGreyLevelEmphasisData();
  
  void GenerateShortRunHighGreyLevelEmphasisData();
  
  void GenerateLongRunLowGreyLevelEmphasisData();
  
  void GenerateLongRunHighGreyLevelEmphasisData();
